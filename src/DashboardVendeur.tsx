...
import CreerAnnonce from './pages/vendeur/CreerAnnonce';
import MonCompte from './pages/vendeur/MonCompte';
import ListeCommandes from './pages/vendeur/ListeCommandes';
import DetailCommande from './pages/vendeur/DetailCommande';
import PaiementsCommandes from './pages/vendeur/PaiementsCommandes';
import ListeCommissions from './pages/vendeur/ListeCommissions';
import RetourRemboursements from './pages/vendeur/RetourRemboursements';
import CommandesBrouillons from './pages/vendeur/CommandesBrouillons';
import DocumentsVendeur from './pages/vendeur/DocumentsVendeur';
import ConfigurationGenerale from './pages/vendeur/ConfigurationGenerale';
import ListeProduits from './pages/vendeur/ListeProduits';
import Categories from './pages/vendeur/Categories';
import MessagerieAcheteur from './pages/vendeur/MessagerieAcheteur';
import MessagerieAdministration from './pages/vendeur/MessagerieAdministration';
import MessagerieNotifications from './pages/vendeur/MessagerieNotifications';
import MonForfait from './pages/vendeur/MonForfait';
import PlansMembership from './pages/vendeur/PlansMembership';
import RapportVendeur from './pages/vendeur/RapportVendeur';
import MesAvis from './pages/vendeur/MesAvis';
import AvisProduits from './pages/vendeur/AvisProduits';
import MesBlogs from './pages/vendeur/MesBlogs';
import MaFaq from './pages/vendeur/MaFaq';
import FacturesVendeur from './pages/vendeur/FacturesVendeur';
import MesEncheres from './pages/vendeur/MesEncheres';
import ReductionsRabais from './pages/vendeur/ReductionsRabais';
import TagsProduits from './pages/vendeur/TagsProduits';
import TypesProduits from './pages/vendeur/TypesProduits';
import ConnecterBoutique from './pages/vendeur/ConnecterBoutique';
import ModifierAnnonce from './pages/vendeur/modifier-annonce';
import MesBadges from './pages/vendeur/MesBadges';
import MethodesExpedition from './pages/vendeur/MethodesExpedition';
import MesOffres from './pages/vendeur/MesOffres';
import { API_BASE } from './config/api';
import TemplateBoutique from './pages/vendeur/TemplateBoutique';
