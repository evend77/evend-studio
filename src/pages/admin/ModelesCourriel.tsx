...
const SUJETS: Record<number, string> = {
  ...
  66: '⏰ Votre période d\'essai e-Vend Studio se termine demain',
  67: '🔔 Votre période d\'essai est terminée — configurez votre paiement',
  68: '🚨 Dernière chance — vos données seront supprimées dans 24h',
...
<div class='content'>
  ...
  },
  {
    ...
    variables: [
    ...VC,
    { cle: '{$nom_gestionnaire}', desc: 'Nom du gestionnaire' },
    { cle: '{$date_fin_essai}', desc: 'Date de fin de l\'essai' },
    { cle: '{$lien_paiement}', desc: 'Lien pour configurer le paiement' },
    ],
  },
  {
    ...
    { cle: '{$nom_gestionnaire}', desc: 'Nom du gestionnaire' },
    { cle: '{$date_fin_essai}', desc: 'Date de fin de l\'essai' },
    { cle: '{$date_suppression}', desc: 'Date de suppression prévue (+48h)' },
    { cle: '{$lien_paiement}', desc: 'Lien pour configurer le paiement' },
    ],
  },
  {
